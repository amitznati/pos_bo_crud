...
<script type="text/javascript">
	...
	function mapProperties(){
		var arr = {!!isset($entry) ? $entry->properties : [] !!};
			var retVal = [];
			arr.forEach(function(prop){
				var property = new Property();
				property.name(prop.name);
				property.type(prop.property_type.id);
				property.valid_values(prop.valid_values);
				property.mandatory(prop.mandatory);
				property.options_required(prop.property_type.options_required);
	...
	function MyViewModel() {
	    ...
	    this.properties = ko.observableArray(mapProperties());
